...
export default function PhotoDetailPage({ params }: { params: { id: string } }) {
  ...
  const imageUrl = getImageUrl(photo.url) || "/placeholder.svg"
  console.log("Image URL:", imageUrl);
  return (
    <>
      {/* Add Open Graph meta tags */}
      <Head>
        <title>{photo.title} | {collection.name}</title>
        <meta property="og:title" content={photo.title} />
        <meta property="og:description" content={photo.description || "A beautiful photo from the collection."} />
        <meta property="og:image" content={imageUrl} />
        <meta property="og:url" content={pageUrl} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={photo.title} />
        <meta name="twitter:description" content={photo.description || "A beautiful photo from the collection."} />
